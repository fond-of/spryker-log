...
class LogConfig extends BaseLogConfig
{
    ...
    {
        return $this->get(LogConstants::AWS_LOG_GROUP_NAME_GLUE, LogConstants::AWS_LOG_GROUP_NAME_GLUE_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogConstants::AWS_LOG_STREAM_NAME_GLUE, LogConstants::AWS_LOG_STREAM_NAME_GLUE_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogConstants::AWS_LOG_LEVEL_GLUE, LogConstants::AWS_LOG_LEVEL_GLUE_DEFAULT_VALUE);
    }
