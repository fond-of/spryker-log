...
class LogConfig extends BaseLogConfig
{
    ...
    {
        return $this->get(LogConstants::AWS_LOG_GROUP_NAME_ZED, LogConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogConstants::AWS_LOG_STREAM_NAME_ZED, LogConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogConstants::AWS_LOG_LEVEL_ZED, LogConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE);
    }
    ...
    {
        return $this->get(LogConstants::AWS_LOG_FORMATTER_TYPE_ZED, LogConstants::LOG_FORMATTER_TYPE_LINE);
    }
}
