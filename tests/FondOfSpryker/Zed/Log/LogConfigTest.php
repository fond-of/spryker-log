...
{
    /**
     * @var \FondOfSpryker\Zed\Log\LogConfig|\PHPUnit\Framework\MockObject\MockObject
     */
    protected $logConfig;
    ...
    public function testGetAwsLogGroupName(): void
    {
        $this->logConfig->expects($this->atLeastOnce())
            ->method('get')
            ->with(LogConstants::AWS_LOG_GROUP_NAME_ZED, LogConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE)
            ->willReturn(LogConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE);

        $this->assertEquals(
            LogConstants::AWS_LOG_GROUP_NAME_ZED_DEFAULT_VALUE,
    ...
    public function testGetAwsLogStreamName(): void
    {
        $this->logConfig->expects($this->atLeastOnce())
            ->method('get')
            ->with(LogConstants::AWS_LOG_STREAM_NAME_ZED, LogConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE)
            ->willReturn(LogConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE);

        $this->assertEquals(
            LogConstants::AWS_LOG_STREAM_NAME_ZED_DEFAULT_VALUE,
    ...
    public function testGetAwsLogLevel(): void
    {
        $this->logConfig->expects($this->atLeastOnce())
            ->method('get')
            ->with(LogConstants::AWS_LOG_LEVEL_ZED, LogConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE)
            ->willReturn(LogConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE);

        $this->assertEquals(
            LogConstants::AWS_LOG_LEVEL_ZED_DEFAULT_VALUE,
